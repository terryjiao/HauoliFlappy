...
import com.weitong.flappycow.Game.MyHandler;
import com.weitong.flappycow.sprites.Background;
import com.weitong.flappycow.sprites.Coin;
import com.weitong.flappycow.sprites.Cow;
import com.weitong.flappycow.sprites.Frontground;
import com.weitong.flappycow.sprites.NyanCat;
import com.weitong.flappycow.sprites.Obstacle;
import com.weitong.flappycow.sprites.PauseButton;
import com.weitong.flappycow.sprites.PlayableCharacter;
import com.weitong.flappycow.sprites.PowerUp;
import com.weitong.flappycow.sprites.Toast;
import com.weitong.flappycow.sprites.Tutorial;
...
public class GameView extends SurfaceView {
    ...
    private double[] mDists = new double[1];
    ...
    public void track() {
        HauoliTracker.getDists(mDists);
        if (mDist - mDists[0] > 5.0) {
            setSimulateClick(game.view, 100.0f, 100.0f);
        }
        mDist = mDists[0];

        Log.d("Hauoli", "est dist = " + mDists[0]);
        try {
            Thread.sleep(10);
        } catch (Exception e) {
